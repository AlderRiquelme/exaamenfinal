    ...
    <div class="modal-content">
      ...
      <div class="modal-body m-3">
        <div class="text-center">
          <img class="img-thumbnail rounded-circle" src="<?php echo BASE_URL . 'assets/img/logo01.png'; ?>" alt="" width="100">
        </div>
        <div class="row">
          ...
          <div class="col-md-12 d-none" id="frmRegister">
            ...
            <div class="form-group mb-3">
              ...
              <input id="claveRegistro" class="form-control" type="text" name="claveRegistro" placeholder="ña">
            </div>
